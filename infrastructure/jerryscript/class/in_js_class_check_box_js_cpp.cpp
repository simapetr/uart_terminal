/**
  ****************************************************************************
  * @file    in_js_class_check_box_js_cpp.cpp
  * @author  Ing. Petr Simek
  * @version V1.0
  * @date    30.10.2018
  * @brief   JerryScript wrapper for component check box
  ****************************************************************************
  * @attention
...
/**
  * @defgroup Check_box
  * @brief Check box class definition
  * @{
  */
...
void check_box_js_c::reg_host_class (void* p_gui_interface_void)
{
...
jerry_value_t name_jerry_value;
    ...
    name_jerry_value = jerry_create_string((const jerry_char_t*)"check_box");
...
/** @brief Add new check box (JS function "add")
 *
...
uint32_t check_box_js_c::add(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
void* p_arg_void;
check_box_js_c* p_bkp_this = NULL;
double check_box_index_d = 0.0;
...
static uint8_t *p_data_sui8 = NULL;
    ...
    {
        // Extract this
        p_bkp_this = reinterpret_cast<check_box_js_c*>(p_arg_void);
        ...
        if(args_cnt_ui32 == 5 && p_bkp_this)
        {
              ...
              )
            {
                ...
                if (p_bkp_this)
                {
                    ...
                    delete[] p_data_sui8;
                    check_box_index_d = ((gui_frame*)(p_bkp_this->lp_gui_interface_void))->add_check_box(jerry_get_number_value(p_args_ui32[0]), text_str, jerry_get_number_value(p_args_ui32[2]),jerry_get_boolean_value(p_args_ui32[3]),jerry_get_boolean_value(p_args_ui32[3]));
                }
            }
        }
        else
...
/** @brief Set check box click event (JS method "reg_event")
 *
 * @param [IN] funct_ui32 : Unused
 * @param [IN] this_ui32 : Pointer on construct class
 * @param [IN] p_args_ui32 : Pointer on argument field
...
uint32_t check_box_js_c::reg_event(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
bool status_b = false;
void* p_arg_void;
check_box_js_c* p_bkp_this = NULL;
...
/** @brief Set check box state (JS method "set")
 *
 * @param [IN] funct_ui32 : Unused
 * @param [IN] this_ui32 : Pointer on construct class
 * @param [IN] p_args_ui32 : Pointer on argument field
...
uint32_t check_box_js_c::set(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
bool status_b = false;
void* p_arg_void;
check_box_js_c* p_bkp_this = NULL;
...
/** @brief Get check box state (JS method "get")
 *
 * @param [IN] funct_ui32 : Unused
 * @param [IN] this_ui32 : Pointer on construct class
 * @param [IN] p_args_ui32 : Pointer on argument field
...
uint32_t check_box_js_c::get(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
void* p_arg_void;
check_box_js_c* p_bkp_this = NULL;
bool status_b = false;
