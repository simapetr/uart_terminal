/**
  ****************************************************************************
  * @file    in_js_class_static_text_js_cpp.cpp
...
/**
  * @defgroup Static_text
  * @brief Static text class definition
  * @{
  */
...
void  static_text_js_c::reg_host_class (void* p_gui_interface_void)
{
...
jerry_value_t name_jerry_value;
    ...
    name_jerry_value = jerry_create_string((const jerry_char_t*)"static_text");
...
/** @brief Add new Static text (JS function "add")
 *
...
uint32_t static_text_js_c::add(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
void* p_arg_void;
static_text_js_c* p_bkp_this = NULL;
...
static uint8_t *p_data_sui8 = NULL;
    ...
    {
        // Extract this
        p_bkp_this = reinterpret_cast<static_text_js_c*>(p_arg_void);
        ...
        if(args_cnt_ui32 == 4 && p_bkp_this)
        {
              ...
              )
            {
                ...
                if (p_bkp_this)
                {
                    ...
                    delete[] p_data_sui8;
                    button_index_d = ((gui_frame*)(p_bkp_this->lp_gui_interface_void))->add_static_text(jerry_get_number_value(p_args_ui32[0]), text_str, jerry_get_number_value(p_args_ui32[2]),jerry_get_boolean_value(p_args_ui32[3]));
                }
            }
        }
    }
...
/** @brief Set static text (JS method "set")
 *
 * @param [IN] funct_ui32 : Unused
 * @param [IN] this_ui32 : Pointer on construct class
 * @param [IN] p_args_ui32 : Pointer on argument field
...
uint32_t static_text_js_c::set(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
bool status_b = false;
void* p_arg_void;
static_text_js_c* p_bkp_this = NULL;
    ...
    if(jerry_get_object_native_pointer(this_ui32, &p_arg_void, NULL))
    {
        ...
        if(args_cnt_ui32 == 2 && p_bkp_this)
        {
              ...
              )
            {
                ...
                delete[] p_data_sui8;
                status_b = ((gui_frame*)(p_bkp_this->lp_gui_interface_void))->set_static_text(jerry_get_number_value(p_args_ui32[0]), text_str);
            }
        }
    }
    // Cast it back to JavaScript and return
