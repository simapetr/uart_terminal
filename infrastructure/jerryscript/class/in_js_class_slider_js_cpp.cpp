/**
  ****************************************************************************
  * @file    in_js_class_slider_js_cpp.cpp
  * @author  Ing. Petr Simek
  * @version V1.0
  * @date    13.09.2018
  * @brief   JerryScript wrapper for component slider
  ****************************************************************************
  * @attention
...
void  slider_js_c::reg_host_class (void* p_gui_interface_void)
{
...
jerry_value_t name_jerry_value;
    ...
    name_jerry_value = jerry_create_string((const jerry_char_t*)"slider");
...
/** @brief Add new slider (JS function "add")
 *
...
uint32_t slider_js_c::add(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
void* p_arg_void;
slider_js_c* p_bkp_this = NULL;
double slider_index_d = 0.0;

    if(jerry_get_object_native_pointer(jerry_get_global_object(), &p_arg_void, NULL))
    {
        // Extract this
        p_bkp_this = reinterpret_cast<slider_js_c*>(p_arg_void);
        ...
        if(args_cnt_ui32 == 5 && p_bkp_this)
        {
              ...
              )
            {
                ...
                if (p_bkp_this)
                {
                    slider_index_d = ((gui_frame*)(p_bkp_this->lp_gui_interface_void))->add_slider(jerry_get_number_value(p_args_ui32[0]), jerry_get_number_value(p_args_ui32[1]), jerry_get_number_value(p_args_ui32[2]), jerry_get_number_value(p_args_ui32[3]),jerry_get_boolean_value(p_args_ui32[4]));
                }
            }
        }
        else
...
/** @brief Set slider update event (JS method "reg_event")
 *
 * @param [IN] funct_ui32 : Unused
 * @param [IN] this_ui32 : Pointer on construct class
 * @param [IN] p_args_ui32 : Pointer on argument field
...
uint32_t slider_js_c::reg_event(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
bool status_b = false;
void* p_arg_void;
slider_js_c* p_bkp_this = NULL;
...
/** @brief Get slider data (JS function "get")
 *
 * @param [IN] funct_ui32 : Unused
 * @param [IN] this_ui32 : Pointer on construct class
 * @param [IN] p_args_ui32 : Pointer on argument field
...
uint32_t slider_js_c::get(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
void* p_arg_void;
slider_js_c* p_bkp_this = NULL;
double data_d = 0.0;
    ...
    if(jerry_get_object_native_pointer(jerry_get_global_object(), &p_arg_void, NULL))
    {
        ...
        if(args_cnt_ui32 == 1 && p_bkp_this)
        {
              ...
              )
            {
                ...
                if (p_bkp_this)
                {
                    data_d = (double)((gui_frame*)(p_bkp_this->lp_gui_interface_void))->get_slider_data(jerry_get_number_value(p_args_ui32[0]));
                }
            }
        }
        else
...
/** @brief Set slider data (JS function "set")
 *
 * @param [IN] funct_ui32 : Unused
 * @param [IN] this_ui32 : Pointer on construct class
 * @param [IN] p_args_ui32 : Pointer on argument field
...
uint32_t slider_js_c::set(const uint32_t funct_ui32, const uint32_t this_ui32, const uint32_t *p_args_ui32, const uint32_t args_cnt_ui32)
{
void* p_arg_void;
slider_js_c* p_bkp_this = NULL;
