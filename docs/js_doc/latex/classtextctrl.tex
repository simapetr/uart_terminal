...
Read data 
\end{DoxyReturn}
\mbox{\label{classtextctrl_a75fbd30a9a500e6dc87331a7d5d18074}} 
\index{textctrl@{textctrl}!set@{set}}
\index{set@{set}!textctrl@{textctrl}}
\subsubsection{set()}
{\footnotesize\ttfamily set (\begin{DoxyParamCaption}\item[{textctrl\+\_\+index\+\_\+d}]{,  }\item[{text\+\_\+str}]{ }\end{DoxyParamCaption})}
